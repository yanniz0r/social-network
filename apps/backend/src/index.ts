  ...
  const subscriptionServer = SubscriptionServer.create(
    {
      ...
      async subscribe(executionContext) {
        ...
        await contextValue.authorizationService.authenticateUser(
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MWUyZDEwMjIyZTZkYmY4YjI4ZTI3NWEiLCJpYXQiOjE2NDI2MjE0NDB9.HL4otW7I5C4kIv_tCgAXkIEsIuLXEAFCFyGKtdblKts"
        );
        return subscribe({
          ...executionContext,
