  ...
  return (
    <div className="relative group inline-flex items-center justify-center">
      <div className="transition-all opacity-0 left-auto group-hover:opacity-100 absolute bottom-0 group-hover:bottom-full">
        <div className="whitespace-nowrap bg-gray-100 text-xs py-1.5 px-3 rounded-lg shadow">
          {text}
        </div>
        <div className="flex items-center justify-center fill-current text-gray-100">
