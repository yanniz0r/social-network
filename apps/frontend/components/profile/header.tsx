...
const ProfileHeader: FC<ProfileHeaderProps> = (props) => {
  ...
  const avatarClassName = classNames(
    "absolute bg-teal-500 border-4 border-gray-800 rounded-full transition-all overflow-hidden flex items-center justify-center text-3xl",
    {
  ...
  const contaienerClassName = classNames(
    "px-10 flex flex-row gap-5 h-28 bg-gray-800 sticky z-10 top-0 transition-all",
    {
  ...
  return (
    <div className={contaienerClassName} ref={containerRef}>
